...
const ZH_MESSAGES = {
  ...
  "app.nav.inventory": "本机 Skill",
  "app.nav.library": "中央库",
  "app.nav.discover": "发现与安装",
  "app.nav.trash": "回收站",
  "app.nav.activity": "操作记录",
  "app.nav.ai": "模型与 API",
...
const EN_MESSAGES: Record<TranslationKey, string> = {
  ...
  "app.nav.inventory": "Local Skills",
  "app.nav.library": "Central Library",
  "app.nav.discover": "Discover & Install",
  "app.nav.trash": "Trash",
  "app.nav.activity": "Activity",
  "app.nav.ai": "Models & API",
